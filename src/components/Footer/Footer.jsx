      ...
      >
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="flex justify-center text-purple-500 items-center sm:justify-start">
                <svg
                ...
                <span className="font-bold text-2xl"> BeFlox movie</span>
              </div>
          ...
          <div class="mt-16 border-t border-gray-100 pt-8 ">
            <p class="text-center text-sm leading-relaxed text-gray-500 bg-black">
              © Project 2022. All rights reserved.
              <br />
              Created by{" "}
              <a
                href="https://www.facebook.com/profile.php?id=100010037773828"
                class="text-purple-500 underline transition hover:text-purple-600/75"
              >
                Vũ Trọng Thắng
              </a>
              .
